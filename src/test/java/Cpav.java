...
public class Cpav extends Base {
    ...
    @Test
    public void ValidarTodasAsOpcoesSliderTelaDiaVencimento()
    {
        driver.findElementByName("ACESSE SUA CONTA").click();
        driver.findElementByClassName("XCUIElementTypeTextField").sendKeys("juliano");
        driver.findElementByName("CONTINUAR").click();
        ...
        //Verifica data vencimento antes de alterar
        ...
        //Valida se o vencimento foi alterado corretamente
        Assert.assertTrue(driver.findElementByXPath("//XCUIElementTypeStaticText[@name=\"15\"]").isDisplayed());
    }
}
