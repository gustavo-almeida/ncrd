...
public class Cpav extends Base {
    ...
    @Test
    public void ValidarMenuLateralEOpcaoDeVoltarTelaEntrada()
    {
        driver.findElementByName("ACESSE SUA CONTA").click();
        driver.findElementByClassName("XCUIElementTypeTextField").sendKeys("juliano");
        driver.findElementByName("CONTINUAR").click();
        ...
        Assert.assertTrue(driver.findElementByAccessibilityId("INFORMAÇÕES SOBRE O VEÍCULO").isDisplayed());
    }
    ...
    @Test
    public void ValidarMenuLateralEOpcaoVoltarTelaDiaDeVencimento()
    {
        driver.findElementByName("ACESSE SUA CONTA").click();
        driver.findElementByClassName("XCUIElementTypeTextField").sendKeys("juliano");
        driver.findElementByName("CONTINUAR").click();
    ...
    @Test
    public void ValidarMenuLateralEOpcaoVoltarTelaDeParcelas()
    {
        driver.findElementByName("ACESSE SUA CONTA").click();
        driver.findElementByClassName("XCUIElementTypeTextField").sendKeys("juliano");
        driver.findElementByName("CONTINUAR").click();
